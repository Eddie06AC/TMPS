...
void Ñash_register_Simple::set_profit(int profit, Client* mas, int money, float rate) { this->profit = profit; }
...
void ObjectPool::handler(Ñash_register* other, Client** mas, int length, int flagg[], float rate)
{
    const char* tmp;
    int k = 0, l = 0;
